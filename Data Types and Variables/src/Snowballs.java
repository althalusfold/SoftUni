...
public class Snowballs {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < snowballsCount; i++){
            ...
            if (snowballValue > originalValue) {
                originalValue = snowballValue;
                snow = snowballSnow;
                time = snowballTime;
                value = snowballValue;
...
//Tony and Andi love playing in the snow and having snowball fights, but they always argue about which makes the best
// snowballs. They have decided to involve you in their fray by making you write a program that calculates snowball
